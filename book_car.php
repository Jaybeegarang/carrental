			...
			?>
				...
				<form method="post">
					<table>
						...
						<tr>
						    <td>Date and time:</td>
							<td><input type="datetime" name="daytime" required></td>
						</tr>
						<tr>
							<td>Location:</td>
				...
				<?php
						if(isset($_POST['save'])){
							...
							$qry = "INSERT INTO client (fname,id_no,gender,email,phone,location,daytime,car_id,status)
							VALUES('$fname','$id_no','$gender','$email','$phone','$location','daytime','$_GET[id]','Pending')";
