	...
	<div class="shell">
		...
		<div id="main">
			...
			<div id="content">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT client.client_id,client.fname,client.phone,client.daytime,cars.car_name,client.mpesa,client.status
							...
							<tr>
								...
								<td><a href="#"><?php echo $row['mpesa'] ?></a></td>
                ...
                <td><h3><a href="#"><?php echo $row['daytime'] ?></a></h3></td>
							</tr>
							<?php
								}
							?>
